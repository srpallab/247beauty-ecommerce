        ...
        <div class="col-lg-12">
            <div class="card card-outline-success">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i> Add State </h4>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('state.insert') }}" id="myForm" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        <div class="row row-sm">
                            ...
                            <div class="col-sm-12 mt-4">
                                <div class="text-center">
                                    <button type="submit" class="btn btn-dark registration-btn">Save State</button>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <tbody>
                            @foreach($states as $state)
                                <tr>
                                    ...
                                    <td>
                                        <a class="view-icon" href="{{ url('admin/state/view/'.$state->state_slug) }}"><i class="bx bx-plus-medical"></i></a>
                                        <a class="edit-icon" href="{{ url('admin/state/edit/'.$state->state_slug) }}"><i class="bx bx-edit"></i></a>

                                        <a class="delete-icon" id="softDelete" data-bs-toggle="modal" data-bs-target="#softDelModal" data-id="{{$state->id}}" href="#"><i class="bx bxs-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
