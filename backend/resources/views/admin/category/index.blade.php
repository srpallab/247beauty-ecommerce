    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-success">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('category.insert') }}" id="myForm" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <tbody>
                            @foreach($categories as $item)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset('uploads/admin/category/'.$item->category_image)}}" alt="" style="height: 60px; width:60px;">
                                    </td>
                                    <td>
                                        <a class="view-icon" href="{{ url('admin/category/view/'.$item->category_slug) }}"><i class="bx bx-plus-medical"></i></a>
                                        <a class="edit-icon" href="{{ url('admin/category/edit/'.$item->category_slug) }}"><i class="bx bx-edit"></i></a>
