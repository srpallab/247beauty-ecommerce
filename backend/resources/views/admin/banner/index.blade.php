                        ...
                        <tbody>
                            @foreach($banner as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a class="view-icon" href="{{ url('admin/banner/view/'.$item->ban_slug) }}"><i class="bx bx-plus-medical"></i></a>
                                        <a class="edit-icon" href="{{ url('admin/banner/edit/'.$item->ban_slug) }}"><i class="bx bx-edit"></i></a>
